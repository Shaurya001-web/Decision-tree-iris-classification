...
This project demonstrates the implementation of a **Decision Tree Classifier** using the Iris dataset. It focuses on understanding how decision trees work and how hyperparameters like `max_depth` help control overfitting.
